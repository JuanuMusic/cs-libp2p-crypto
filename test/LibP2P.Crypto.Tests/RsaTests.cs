...
namespace LibP2P.Crypto.Tests
{
    public class RsaTests
    {
        ...
        public void CanUnmarshalPrivateKeyAndMarshalPublicKey_FromReferenceImpl()
        {
            ...
            Assert.AreEqual("CAASXjBcMA0GCSqGSIb3DQEBAQUAA0sAMEgCQQCvNQkMgofMnx/cdtpSEDJAtq0lj/zFW+9214vau7moGaH2U7FTBVGY1mGYv7jZLZjgimiXS9isyCdOKJcJGTeBAgMBAAE=", pub);
        }
        ...
        private void TestKeyEquals(Key key)
        {
            ...
            Assert.AreEqual(key, new MockKey(KeyType.RSA, kb));
        }
